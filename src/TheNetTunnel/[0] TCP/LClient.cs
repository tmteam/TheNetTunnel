...
namespace TheTunnel
{
    ...
    public class LClient
    {
        ...
        public LClient(TcpClient client)
        {
            ...
            qReceiver.OnLightMessage += (QuantumReceiver arg1, QuantumHead arg2, MemoryStream arg3) =>
            {
                if (OnReceive != null)
                    OnReceive(this, arg3);
            };
        ...
        private int maxQSize = 9000;

        #region private

        private QuantumSender   qSender;
        private QuantumReceiver qReceiver;
