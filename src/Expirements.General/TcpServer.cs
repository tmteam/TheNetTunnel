...
{
    //public class TcpServer<TContract>:IChannelServer<TcpChannel,TContract>
    //{
    //    private readonly ConnectionBuilder<TContract, TcpChannel> _channelBuilder;
    //    private readonly IPEndPoint _endpoint;
    //    private TcpListener _listener = null;

    //    readonly ConcurrentDictionary<IChannel, Connection<TContract, TcpChannel>> _connections 
    //        = new ConcurrentDictionary<IChannel, Connection<TContract, TcpChannel>>();

    //    private IAsyncResult _listenResults;
    //    public bool IsListening => _listener != null;

    //    public event Action<IChannelServer<TcpChannel, TContract>, BeforeConnectEventArgs<TContract, TcpChannel>> BeforeConnect;
    //    public event Action<IChannelServer<TcpChannel, TContract>, Connection<TContract, TcpChannel>> AfterConnect;
    //    public event Action<IChannelServer<TcpChannel, TContract>, Connection<TContract, TcpChannel>> Disconnected;
    //    public TcpServer(ConnectionBuilder<TContract, TcpChannel> channelBuilder, IPEndPoint endpoint)
    //    {
    ...
    //    {
    //        Connection<TContract, TcpChannel> connection;
    ...
    //    public IEnumerable<Connection<TContract, TcpChannel>> GetAllConnections()
    //    {
    ...
    //    protected virtual void OnAfterConnect(Connection<TContract, TcpChannel> arg2)
    //    {
    //        AfterConnect?.Invoke(this, arg2);
    //    }

    //    protected virtual void OnDisconnected(Connection<TContract, TcpChannel> arg2)
    //    {
