...
namespace TNT.Cords
{
	...
	//Strangest code i've ever wrote:
    ...
    class FuncCallConverterSubFactory<T1, T2, T3, T4, T5, OutT> : IFuncCallConverterSubFactory
    {
        public Delegate GetFuncConverter(Func<object[], object> fnc)
        {
            TNTFunc<T1, T2, T3, T4, T5, OutT> ans = (t1, t2, t3, t4, t5) => (OutT)fnc(new object[] { t1, t2, t3, t4, t5 });
            return ans;
        }
    }
    class FuncCallConverterSubFactory<T1, T2, T3, T4, T5, T6, OutT> : IFuncCallConverterSubFactory
    {
        public Delegate GetFuncConverter(Func<object[], object> fnc)
        {
            TNTFunc<T1, T2, T3, T4, T5, T6, OutT> ans = (t1, t2, t3, t4, t5, t6) => (OutT)fnc(new object[] { t1, t2, t3, t4, t5, t6 });
            return ans;
        }
    }
    class FuncCallConverterSubFactory<T1, T2, T3, T4, T5, T6, T7, OutT> : IFuncCallConverterSubFactory
    {
        public Delegate GetFuncConverter(Func<object[], object> fnc)
        {
            TNTFunc<T1, T2, T3, T4, T5, T6, T7, OutT> ans = (t1, t2, t3, t4, t5, t6, t7) => (OutT)fnc(new object[] { t1, t2, t3, t4, t5, t6, t7 });
            return ans;
        }
    }
        ...
        : IFuncCallConverterSubFactory
    {
        public Delegate GetFuncConverter(Func<object[], object> fnc)
        {
            TNTFunc<T1, T2, T3, T4, T5, T6, T7, T8, OutT> ans
        ...
        : IFuncCallConverterSubFactory
    {
        public Delegate GetFuncConverter(Func<object[], object> fnc)
        {
            TNTFunc<T1, T2, T3, T4, T5, T6, T7, T8, T9, OutT> ans
        ...
        : IFuncCallConverterSubFactory
    {
        public Delegate GetFuncConverter(Func<object[], object> fnc)
        {
            TNTFunc<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, OutT> ans
        ...
        : IFuncCallConverterSubFactory
    {
        public Delegate GetFuncConverter(Func<object[], object> fnc)
        {
            TNTFunc<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, OutT> ans
        ...
        : IFuncCallConverterSubFactory
    {
        public Delegate GetFuncConverter(Func<object[], object> fnc)
        {
            TNTFunc<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, OutT> ans
