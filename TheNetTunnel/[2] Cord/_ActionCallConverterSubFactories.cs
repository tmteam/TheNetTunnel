...
namespace TNT.Cords
{
    ...
    class ActionCallConverterSubFactory<T1, T2, T3, T4, T5> : IActionCallConverterSubFactory
    {
        public Delegate GetActionConverter(Action<object[]> act)
        {
            TNTAction<T1, T2, T3, T4, T5> ans = (t1, t2, t3, t4, t5) => act(new object[] { t1, t2, t3, t4, t5 });
            return ans;
        }
    }
    class ActionCallConverterSubFactory<T1, T2, T3, T4, T5, T6> : IActionCallConverterSubFactory
    {
        public Delegate GetActionConverter(Action<object[]> act)
        {
            TNTAction<T1, T2, T3, T4, T5, T6> ans = (t1, t2, t3, t4, t5, t6) => act(new object[] { t1, t2, t3, t4, t5, t6 });
            return ans;
        }
    }
    class ActionCallConverterSubFactory<T1, T2, T3, T4, T5, T6, T7> : IActionCallConverterSubFactory
    {
        public Delegate GetActionConverter(Action<object[]> act)
        {
            TNTAction<T1, T2, T3, T4, T5, T6, T7> ans = (t1, t2, t3, t4, t5, t6, t7) => act(new object[] { t1, t2, t3, t4, t5, t6, t7 });
            return ans;
        }
    }
        ...
        : IActionCallConverterSubFactory
    {
        public Delegate GetActionConverter(Action<object[]> act)
        {
            TNTAction<T1, T2, T3, T4, T5, T6, T7, T8> ans
        ...
        : IActionCallConverterSubFactory
    {
        public Delegate GetActionConverter(Action<object[]> act)
        {
            TNTAction<T1, T2, T3, T4, T5, T6, T7, T8, T9> ans
        ...
        : IActionCallConverterSubFactory
    {
        public Delegate GetActionConverter(Action<object[]> act)
        {
            TNTAction<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> ans
        ...
        : IActionCallConverterSubFactory
    {
        public Delegate GetActionConverter(Action<object[]> act)
        {
            TNTAction<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> ans
        ...
        : IActionCallConverterSubFactory
    {
        public Delegate GetActionConverter(Action<object[]> act)
        {
            TNTAction<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> ans
