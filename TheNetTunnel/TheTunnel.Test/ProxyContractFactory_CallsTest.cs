...
namespace TheTunnel.Test
{
    ...
    public class ProxyContractFactory_CallsTest
    {
        ...
        {
            var res = _cordMock.Raise<int[]>(CordMock.FuncReturnsArrayCallId);
            Assert.IsNull(res);
        }
        ...
        public void MockRaises_ArgumentProcedureCall_CalledWithCorrectArguments()
        {
            ...
            _cordMock.Raise(CordMock.ArgumentProcedureCallId, intSendArg, stringSendArg);
        ...
        public void MockRaises_ArrayArgumentProcedureCall_CalledWithCorrectArguments()
        {
            ...
            _cordMock.Raise(CordMock.ArrayArgumentProcedureCallId, intSendArg, stringSendArg);
        ...
        public void MockRaises_FuncCallReturnsRefType_returnsCorrectValue()
        {
            ...
            var res = _cordMock.Raise<string>(CordMock.FuncCallReturnsRefTypeId);
            Assert.AreEqual(returnValue, res);
        }
        ...
        public void MockRaises_ArgumentFuncCall_receivedCorrectArguments()
        {
           ...
           _cordMock.Raise<int>(CordMock.ArgumentFuncCallId, sendValue1,sendValue2);
