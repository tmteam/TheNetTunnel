...
[TestFixture]
public class MockChannel_BigProtobuffConcurrentCallTest
{
    [TestCase(2)]
    [TestCase(10)]
    [TestCase(100)]
    ...
    public void StringPackets_transmitsViaTcp_Concurrent(int stringLengthInBytes)
    {
    ...
    [TestCase(1000, 40)]
    [TestCase(1200, 40)]
    public void ProtobuffPackets_transmitViaTcp_Concurrent(int sizeOfCompanyInUsers, int parralelTasksCount)
    {
        //1000 = 0.5mb  
        //2000 = 2mb    
        //5000 = 10mb   
